...
const BookingPage = () => {
  return (
    ...
    <nav  className="flex justify-center container max-w-[1141px]  mx-auto">
        <a href=""><img src="/image/Staycation..svg" alt="logo"/></a>
    </nav>
   </header> 

   <main  className="container m-auto max-w-[1141px] md:px-0 px-5">
    <section className="py-10">
        <img className="text-center m-auto py-10" src="/image/stepper.svg" alt="steps"/>
        ...
        <div className="md:flex flex-row justify-center gap-24  items-center">
            <div>
                <img className="md:w-[420px] w-[350px]" src="/image/cashville.svg" alt="cashville"/>
        ...
        <div className="flex flex-col  m-auto py-32 space-y-5">
            <a className="mx-auto" href="./payment.html"> <button className="font-medium text-lg text-white bg-secondary  roundded-[4px] py-3 px-20 ">Continue to Book</button></a>
