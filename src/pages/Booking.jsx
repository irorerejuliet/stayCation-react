...
import { BookingInputs } from "../constant/PaymentInput";
      ...
      <main className="container m-auto max-w-[1141px] md:px-0 px-5">
        <section className="py-10">
          ...
          <div className="text-center m-auto py-10">
            <h2 className="font-semibold md:text-[2.625rem] text-[1.625rem]">
              Booking Information
            </h2>
          ...
          <div className="md:flex flex-row justify-center gap-24  items-center">
            <div>
              ...
              <div className="flex justify-between items-center md:w-[420px] w-[320px]">
                <div>
                  <h3 className="font-medium text-xl text-light pt-3">
                    cashville
                  </h3>
                ...
                <p className="font-medium text-lg">
                  $480 USD{" "}
                  <span className="font-light text-lg text-tertiary">for</span>{" "}
                  2 night
                </p>
              </div>
            </div>
            <form action="">
              {BookingInputs.map(({ label, type, name, placeholder, id }) => (
                <div
                  className="flex flex-col py-3 text-lg font-normal"
                  key={id}
                >
                  <label for={name}>{label}</label>
                  <input
                    className="border border-none bg-[#F5F6F8] py-2 px-6"
                    type={type}
                    name={name}
          ...
          <div className="flex flex-col  m-auto py-32 space-y-5">
            <Link to="/payment" className="mx-auto">
              <Link className="font-medium text-lg text-white bg-secondary  roundded-[4px] py-3 px-20  ">
                Continue to Book
              </Link>
            </Link>
            <button className="font-medium text-lg text-tertiary bg-[#F5F6F8]  roundded-[4px] py-3 px-20 mx-auto text-center w-[300px]">
              Cancel
            </button>
          </div>
        </section>
